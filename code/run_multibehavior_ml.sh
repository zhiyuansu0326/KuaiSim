    ...
    do
        ...
        do
            python "${SCRIPT_DIR}/train_multibehavior.py"\
                ...
                --cuda 0\
                --reader MLSeqReader\
                --train_file ${data_path}log_session.csv\
                --user_meta_file ${data_path}users_processed.csv\
                --item_meta_file ${data_path}movies_processed.csv\
