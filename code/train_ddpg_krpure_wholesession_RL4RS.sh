...
log_name="user_RL4RS_dien_lr0.0001_reg0.01_nlayer2"

# environment args
ENV_CLASS='RL4RS_KREnvironment_WholeSession_GPU'
MAX_STEP=20
SLATE_SIZE=20
EP_BS=32
RHO=0.2
                ...
                do
                    ...
                    do
                        ...
                        python train_actor_critic.py\
                            ...
                            --uirm_log_path ${output_path}env_RL4RS/log/${log_name}.model.log\
