...
# recogym_env = gym.make('reco-gym-v1')
# recogym_env.init_gym(env_1_args)
...
class Recogym_KREnvironment_WholeSession_GPU(BaseRLEnvironment):
    '''
    ...
    def __init__(self, args):
        ...
        '''
        super(Recogym_KREnvironment_WholeSession_GPU, self).__init__(args)
        ...
        env_1_args['random_seed'] = 42
        # Initialize the gym for the first time by calling .make() and .init_gym()
        self.recogym_env = recogym.envs.reco_env_v1.RecoEnv1()
        self.recogym_env.init_gym(env_1_args)
    ...
    def get_response(self, step_dict):
        ...
        # Recogym
        out_dict['probs'] = self.recogym_env.get_response(batch['item_id'])
