...
class RL4RS_KREnvironment_WholeSession_GPU(BaseRLEnvironment):
    '''
    ...
    def __init__(self, args):
        ...
        '''
        super(RL4RS_KREnvironment_WholeSession_GPU, self).__init__(args)
        ...
        assert class_args.reader == 'KRMBSeqReader' and 'RL4RS' in class_args.model
